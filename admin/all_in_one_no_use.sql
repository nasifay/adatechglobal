-- All-in-one migration and seed for Adatech CMS (no USE)
-- Import this file AFTER you select the target database in phpMyAdmin (do NOT rely on the file to switch DB).
-- If your host requires, create the DB via control panel and assign your DB user privileges before importing.
...
-- the index creation line was removed to avoid import errors on restrictive hosts.
