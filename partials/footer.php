<?php
// Clean footer for Adatech Solutions — text-only updates (keeps design and scripts)
?>
<footer id="footer" class="footer">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="footer-info">
            ...
            <p>
              ...
              <strong>Phone:</strong> +251 986 988 762<br>
              <strong>Email:</strong> info@adatechglobal.com<br><br>
        ...
        <div class="col-lg-2 col-md-3 footer-links">
          ...
          <ul>
            ...
            <li><a href="services.php#prototyping">Hardware Prototyping &amp; PCB Design</a></li>
            <li><a href="services.php#cloud">Cloud Hosting &amp; Infrastructure</a></li>
            <li><a href="services.php#mobile">Mobile App Development</a></li>
          </ul>
        </div><!-- End footer links column-->
  ...
  <div class="footer-legal text-center position-relative">
    <div class="container">
      <div class="copyright">
        &copy; <?php echo date('Y'); ?> Adatech Solutions. All Rights Reserved
      </div>
      <div class="credits">
        Designed by Adatech Solutions
      </div>
    </div>
  </div>
</footer>
...
<footer>
  <div class="container">
    <p>&copy; <?php echo date('Y'); ?> Adatech Solutions. All rights reserved.</p>
  </div>
</footer>
<a href="#" class="scroll-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
<div id="preloader"></div>
