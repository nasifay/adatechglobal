<?php
// Temporary admin password reset script (archived copy).
// Original was local-only; moved to archived folder for safekeeping.
// IMPORTANT: Do not leave this accessible on a live site.
...
try {
    ...
    if ($ok) {
        ...
        echo '<p>IMPORTANT: Delete the original file if still present: <code>admin/reset_admin_password.php</code></p>';
    } else {
